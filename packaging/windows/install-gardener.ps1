...
if ($ProvisionUrl) {
  ...
  if (-not $PackageSha256 -and $Provision.packageSha256) { $PackageSha256 = [string]$Provision.packageSha256 }
}
...
& $Updater -PackageUrl $PackageUrl -PackageSha256 $PackageSha256 -InstallDir $InstallDir
