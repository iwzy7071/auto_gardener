...
func (r MockRunner) Run(ctx context.Context, req RunRequest) RunResult {
	...
	case req.Role == "gardener" && strings.Contains(prompt, "快速提问模式"):
		output = "Mock quick answer."
	...
	default:
		...
		if req.WorkDir != "" {
			...
			_ = os.WriteFile(filepath.Join(req.WorkDir, "mock-deliverable.md"), []byte("# Mock deliverable\n\nGenerated by Gardener mock runner.\n"), 0644)
		}
	}
