...
MAX_RELAY_PUBLIC_BASE_URL_LENGTH = 2048
...
def require_relay_configured():
    ...
    if len(RELAY_PUBLIC_BASE_URL) > MAX_RELAY_PUBLIC_BASE_URL_LENGTH:
        raise SystemExit('error: relay public base URL is too long')
